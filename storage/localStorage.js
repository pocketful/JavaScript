...
let total =
  localStorage.getItem("total") === null ? 0 : localStorage.getItem("total");
...
if (localStorage.getItem("total") === null) {
  ...
  total2 = localStorage.getItem("total");
}
h2El.textContent = total2;
...
const buttonEl2 = document.getElementById("btn1");
const h2El = document.querySelector("h2"); // buttonEl2.nextElementSibling;
...
// const namesArray = []; // jei tik taip, tai perkrovus nelieka htmle listo, o cookies uzraso ant virsaus nauja
const namesArray =
...
let personsArray =
  localStorage.getItem("fullnames") === null
    ? []
    : JSON.parse(localStorage.getItem("fullnames"));
