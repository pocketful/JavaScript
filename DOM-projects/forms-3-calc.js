...
inputEl2.addEventListener("input", function () {
  /* 'keyup' neveiks jei su pele paste darysim */ if (inputEl1.value !== "") {
...
inputEl1.addEventListener("input", function () {
  /* 'keyup' neveiks jei su pele paste darysim */ if (inputEl2.value !== "") {
    outEl10.textContent = daugyba();
    outEl20.textContent = sudetis();
  }
});
...
inputEl2.addEventListener("input", function () {
  /* 'keyup' neveiks jei su pele paste darysim */ console.log(
    "aaa",
    inputEl1.value
  );
  if (inputEl1.value !== "") {
