...
const titlesEl2 = document.querySelectorAll(".acc__title");
length = titlesEl2.length;

for (let i = 0; i < length; i++) {
  titlesEl2[i].addEventListener("click", (event) => {
    // console.log(titlesEl2[i]);
    // console.log(titlesEl2.classList);
    titlesEl2[i].nextElementSibling.classList.toggle("acc__text");
  });
}
...
const titlesEl3 = document.querySelectorAll(".acc__title");
length = titlesEl3.length;

for (let i = 0; i < length; i++) {
  titlesEl3[i].addEventListener("click", (event) => {
    for (let i = 0; i < length; i++) {
      titlesEl3[i].nextElementSibling.classList.toggle("acc__text");
    }
  });
}
...
const titlesEl4 = document.querySelectorAll(".acc__title");
length = titlesEl4.length;

for (let i = 0; i < length; i++) {
  titlesEl4[i].addEventListener("click", (event) => {
    for (let i = 0; i < length; i++) {
      titlesEl4[i].nextElementSibling.classList.add("acc__text");
    }
    titlesEl4[i].nextElementSibling.classList.remove("acc__text");
  });
}
