...
document.getElementById("title").textContent =
  "Perrasytas h1 .title textContent"; // perrasytas textas
document.getElementById("title").innerHTML =
  "Perrasytas h1 innerHTML <span style='color:red'>Yes</span>"; // perrasytas textas ir pridetas span
...
document.getElementById("title").textContent =
  "Perrasytas h1 .title textContent"; // perrasom
...
console.log(
  (document.getElementsByClassName("text")[1].textContent = "p. text buvo 2")
); // keiciam teksta
