...
console.log(
  "As esu " +
    ...
    ". Noreciau keliauti i " +
    country +
    ". Mano megstamiausias skaicius yra " +
    bestNumber
);
...
const x2 = document.getElementById("tekstas");
console.log(x2);
x2.textContent = sentence; // pakeiciam teksta jo
// x2.innerHTML = daugyba;  // panasiai veikia
