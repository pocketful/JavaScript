...
for (let i = 61; i <= 70; i++) {
  // arba nuo 60, bet tada papildomas pradzioj veiksmas vienas
...
for (let i = 60; i <= 70; i++) {
  for (let y = 60; y <= 70; y++) {
    // console.log('i ===', i);
    // console.log('y ===', y);
    // let sum2 = i * y; /* 3600 3660 3720 ... */  /* 60 * 61, 60 * 62, 60 * 63.. */
    sum2 =
      sum2 +
      i * y; /* 3600 7260 10980 ... */ /* 60 * 61 + 60 * 62 + 60 * 63.. */
    console.log(`${sum2} === ${i}(i) * ${y}(y)`);
  }
}
console.log("Galutine sum2 ===", sum2);
...
const vid = sum3 / counter;
console.log("sum3 ===", sum3);
console.log("vidurkis ===", vid);
// arba tiesiog
console.log(
  `Skaiciu nuo 2 iki 10 suma yra ${sum3}, o juos padalinus is ${counter}, gauname, kad ju vidurkis yra ${
    sum3 / counter
  }`
);
